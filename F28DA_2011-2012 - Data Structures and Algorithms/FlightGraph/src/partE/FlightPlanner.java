...
public class FlightPlanner {
	...
	private static void calculateRoutes() {
		...
		for(Flight f : flightList) {
			fCount++;
			System.out.format("%3s%15s%7s%7s%15s%7s%7s", fCount, f.getOrigin(), Integer.toString(f.getDeparture()), f.getCode(), f.getDestination(), Integer.toString(f.getArrival()), Double.toString(f.getWeight())+"\n");
		}
