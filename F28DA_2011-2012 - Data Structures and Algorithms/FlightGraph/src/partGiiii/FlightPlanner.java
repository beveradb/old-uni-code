...
public class FlightPlanner {
	...
	private static void calculateRoutes() {
		...
		// Set all flight (edge) weights to the same value so Djikstra's algorithm returns fewest changes instead.
		for(Flight flight : routeGraph.edgeSet()){
			routeGraph.setEdgeWeight(flight, 1);
		}
		...
		restart(new String[]{
			"",
			"Total Number of Changes: "+fCount,
	...
	private static void init() {
		...
		System.out.println("Fewest Changes Flight Path Calculator: version 2.1\n\nAirports available:");
